...
public abstract class ChartBaseManager<T extends Chart, U extends Entry> extends SimpleViewManager<T> {
    ...
    public void setLegend(T chart, ReadableMap propMap) {
        ...
        if (BridgeUtils.validate(propMap, ReadableType.String, "horizontalAlignment")) {
            legend.setHorizontalAlignment(Legend.LegendHorizontalAlignment
                    .valueOf(propMap.getString("horizontalAlignment").toUpperCase(Locale.ENGLISH)));
        }

        if (BridgeUtils.validate(propMap, ReadableType.String, "verticalAlignment")) {
            legend.setVerticalAlignment(Legend.LegendVerticalAlignment
                    .valueOf(propMap.getString("verticalAlignment").toUpperCase(Locale.ENGLISH)));
        }

        if (BridgeUtils.validate(propMap, ReadableType.String, "orientation")) {
            legend.setOrientation(
                    Legend.LegendOrientation.valueOf(propMap.getString("orientation").toUpperCase(Locale.ENGLISH)));
        }
        ...
        if (BridgeUtils.validate(propMap, ReadableType.String, "direction")) {
            legend.setDirection(
                    Legend.LegendDirection.valueOf(propMap.getString("direction").toUpperCase(Locale.ENGLISH)));
        }
